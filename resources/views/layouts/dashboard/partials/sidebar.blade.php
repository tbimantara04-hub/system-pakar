<div class="adminx-sidebar expand-hover push">
    <ul class="sidebar-nav">
        ...
        <!-- Link yang tadinya tersembunyi sekarang akan muncul -->
        <!-- @can('admin-access') Dihapus dari sini -->
        ...
        <!-- LINK YANG HILANG SEBELUMNYA, SEKARANG DITAMBAHKAN -->
        <li class="sidebar-nav-item">
